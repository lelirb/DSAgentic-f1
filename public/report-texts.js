...
(function () {
  const es = {
    ui: {
      ...
      certDemonstrated: "Demostrado",
      certPartial: "Demostrado en parte",
      certNotDemonstrated: "No demostrado",
      certAbsent: "Ausencia demostrada",
      certNotEvaluated: "No evaluado",
      certNA: "No aplica",
      certHelp:
        "Demostrado: hay evidencia suficiente. No demostrado: se buscó y no se encontró evidencia suficiente, lo que no significa que no exista. Ausencia demostrada: la evidencia es completa y permite afirmar que falta. No evaluado: no se pudo evaluar.",
      ...
      rsUnreadable: "esta versión del evaluador todavía no puede leerlo desde páginas web; cuenta como 0 en el puntaje, pero no es un gap demostrado",
      ...
      rUnreadable: "desde páginas web, esta versión del evaluador todavía no puede leer algunas fuentes (propiedades, variantes, estados, patrones)",
      rLinked: "algunos recursos (tokens, índice de componentes, tipos) solo se detectan si están enlazados desde las páginas revisadas",
      ...
      grpDemonstrated: "Demostrado. El sistema documenta:",
      grpNotDemonstrated: "No demostrado (no significa que no exista):",
      grpAbsent: "Ausencia demostrada:",
      grpNotEvaluated: "No evaluado:",
      ...
      d2NotFoundLive:
        "No se encontraron tokens estructurados en las páginas revisadas. El evaluador solo los detecta si están publicados como archivo (por ejemplo, JSON) y enlazados desde la documentación.",
      ...
      engineFindingsIncomplete: "Es el texto original del motor. Con evidencia incompleta, sus frases de ausencia («no se detectaron…») deben leerse como «no demostrado», no como «no existe».",
  ...
  const en = {
    ui: {
      ...
      engineLangNote: "Engine findings are currently generated in Spanish only.",
      coverage: "Coverage",
      ...
      certDemonstrated: "Demonstrated",
      certPartial: "Partly demonstrated",
      certNotDemonstrated: "Not demonstrated",
      certAbsent: "Absence demonstrated",
      certNotEvaluated: "Not evaluated",
      certNA: "Not applicable",
      certHelp:
        "Demonstrated: there is enough evidence. Not demonstrated: we looked and didn't find enough evidence, which doesn't mean it doesn't exist. Absence demonstrated: the evidence is complete and shows it's missing. Not evaluated: it couldn't be evaluated.",
      ...
      rsUnreadable: "this version of the evaluator can't read it from web pages yet; it counts as 0 in the score, but it isn't a demonstrated gap",
      ...
      rUnreadable: "from web pages, this version of the evaluator can't yet read some sources (properties, variants, states, patterns)",
      rLinked: "some resources (tokens, component index, types) are only detected if they're linked from the reviewed pages",
      ...
      grpDemonstrated: "Demonstrated. The system documents:",
      grpNotDemonstrated: "Not demonstrated (doesn't mean it doesn't exist):",
      grpAbsent: "Absence demonstrated:",
      grpNotEvaluated: "Not evaluated:",
      ...
      d2NotFoundLive:
        "No structured tokens were found on the reviewed pages. The evaluator only detects them if they're published as a file (for example, JSON) and linked from the documentation.",
      ...
      engineFindingsIncomplete: "This is the engine's original text. With incomplete evidence, its absence statements (“no … detected”) should be read as “not demonstrated”, not as “doesn't exist”.",
