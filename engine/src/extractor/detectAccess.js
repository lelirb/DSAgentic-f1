...
export function detectAccess(crawlResult) {
  ...
  const hasMcp = urls.some((u) => u.includes("mcp"));
  ...
  return {
    ...
    props_types_accessibility: hasDts ? "PROPS_AND_TYPES" : "NAMES_ONLY",
    structured_tokens: hasTokensJson ? "COMPLETE" : "NOT_RECOVERABLE",
