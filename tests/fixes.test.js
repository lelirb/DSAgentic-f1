...
test("extractor: páginas de plataforma de Fluent 2 (/components/web/react, /components/ios) no se detectan como componentes", async () => {
  const { detectComponents } = await import("../engine/src/extractor/detectComponents.js");
  const { createEvidenceCollector: newCollector } = await import("../engine/src/extractor/evidence.js");

  const crawlResult = {
    pages: [
      { url: "https://fluent2.microsoft.design/components/web/react", contentType: "text/html", body: "<h1>React components</h1><p>Browse all React components.</p>" },
      { url: "https://fluent2.microsoft.design/components/ios", contentType: "text/html", body: "<h1>iOS components</h1><p>Browse all iOS components.</p>" },
      { url: "https://fluent2.microsoft.design/components/android", contentType: "text/html", body: "<h1>Android components</h1>" },
      { url: "https://fluent2.microsoft.design/components/windows", contentType: "text/html", body: "<h1>Windows components</h1>" },
      { url: "https://fluent2.microsoft.design/components/web/react/core/button/usage", contentType: "text/html", body: "<h1>Button</h1><p>A button triggers an action.</p>" },
    ],
    pageRecords: [
      { url: "https://fluent2.microsoft.design/components/web/react", status: "CRAWLED", reason: null },
      { url: "https://fluent2.microsoft.design/components/ios", status: "CRAWLED", reason: null },
      { url: "https://fluent2.microsoft.design/components/android", status: "CRAWLED", reason: null },
      { url: "https://fluent2.microsoft.design/components/windows", status: "CRAWLED", reason: null },
      { url: "https://fluent2.microsoft.design/components/web/react/core/button/usage", status: "CRAWLED", reason: null },
    ],
    stats: {},
  };
  const components = detectComponents(crawlResult, newCollector());
  assert.equal(components.length, 1, "las 4 páginas de plataforma no deben contarse como componentes");
